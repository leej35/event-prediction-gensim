...
if not use_own_backend:
    from gensim.models.word2vec_inner import train_batch_sg, train_batch_cbow
    from gensim.models.word2vec_inner import score_sentence_sg, score_sentence_cbow
    from gensim.models.word2vec_inner import FAST_VERSION, MAX_WORDS_IN_BATCH
else:
    print('Word2Vec: use own backend; not use C-based backend for Event Prediction on CBOW')
    ...
    def score_sentence_cbow(model, sentence, work=None, neu1=None):
        ...
        word_vocabs = [model.wv.vocab[w] for w in context_words if w in model.wv.vocab]
        for pos, word in enumerate(word_vocabs):
            if word is None:
                continue  # OOV word in the input sentence => skip
